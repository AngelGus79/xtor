...
encryptorFormBox model =
    ...
    div []
        [ p [class "control"]
            ...
            , button [class "button is-success", onClick Encryptor, disabled button_disabled] [span [class "icon"] [i [class "fa fa-lock"] []], text "Encrypt"]
            ]
...
decryptorFormBox model =
    ...
    div []
        [ p [class "control"]
            ...
            , button [class "button is-success", onClick Decryptor, disabled button_disabled] [span [class "icon"] [i [class "fa fa-unlock"] []], text "Decrypt"]
            ]
